...
df2=data.frame (
  num= c(56,55,54,53),
  char_vector= c("CVS","REN","HEM","GI")
  
)
View(df2)

df3 <- data.frame(
  char_vector=c("mere sar me dard horaha"),
  logical_vector=c(TRUE),
  num_vector=c(100000000000))
  View(df3)
...
#practcing array I did not get it come back later
